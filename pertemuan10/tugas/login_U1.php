...
require 'functions.php';
	...
	if(isset($_POST["login2"])){
		...
		$result = mysqli_query($conn, "SELECT * FROM user1 WHERE username = '$username'");
	...
	<?php if(isset($error)) : ?>
		<?php 
			...
			echo "
					...
					document.location.href = 'login_U1.php';
					</script>
				";
		 ?>
	...
	<form action="" method="post">
		<center>
			...
			<br/> 	<br/> 	<br/>
				...
				<center>
				<button type="submit" class="tombol_login" name="login2" align="center">login</button>
				</center>
